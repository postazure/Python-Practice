...
#Define the sprite (throttle)

#Calc: Height, velocity, acceleration and fuel consumption

#Display information

#Update fuel gauge

#disp rocket flames (size dependent on thruster

#Blit everything to the screen, Check for mouse events
#update throttle position, check if ship has landed
